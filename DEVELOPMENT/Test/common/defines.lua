...
NDiplomacy = {
	...
	IMPERIAL_AUTHORITY_FROM_PRINCES = 0.1,			-- Scales to threshold	#Changed in Anbennar cos we have less
...
NCountry = {
	...
	PS_ESTABLISH_SIBERIAN_FRONTIER = 90,			-- Anbennar
	...
	COLONIAL_CLAIM_BONUS = 0,						-- Anbennar changed cos tordesillas dont matter
	...
	CONCENTRATE_DEVELOPMENT_DEVELOPMENT_DECREASE = 0, -- ANBENNAR - disabled concentrate development
	...
	SIBERIAN_TRIBE_MIGRATION_BONUS = 25,
	SIBERIAN_TRIBE_MIGRATION_COOLDOWN_YEARS = 1,	-- Anbennar, vanilla is 5
...
NMilitary = {
	...
	RAJPUT_BASE_COST_MODIFIER = 5,					-- Anbennar Artificers are expensive
...
NAI = {
	...
	COLONY_BUDGET_FRACTION = 1, -- AI will spend a maximum of this amount of monthly ducats for colonies.
...
NGraphics = {
	...
	BORDER_WIDTH = 1.0, -- AMYZ EDITED was 1.5
...
NFrontend = {
	...
	CAMERA_LOOKAT_Y = 0.0,
	CAMERA_LOOKAT_Z = 2215.0,		-- AMYZ was 1519
	CAMERA_LOOKAT_SETTINGS_X = 2958.0, 				-- Rotation point in settings
	CAMERA_LOOKAT_SETTINGS_Y = 0.0,					-- Y is height
	CAMERA_LOOKAT_SETTINGS_Z = 2215.0,		-- AMYZ was 1519
	CAMERA_START_X = 2958.0,						-- Initial position in main menu
	CAMERA_START_Y = 800,							-- Y is height
	CAMERA_START_Z = 2096.0,
	CAMERA_END_X = 2958.0,							-- Move to position in main menu
	CAMERA_END_Y = 900.0,
	CAMERA_END_Z = 2096.0,
	CAMERA_MIN_DIST_FOR_ROTATE = 1000.0, 			-- Controlls when rotation starts. When camera is close enought it starts - AMYZ EDITED was 800
	CAMERA_MIN_HEIGHT = 90.0,						-- Minimum camera height - AMYZ EDITED was 50
	CAMERA_MAX_HEIGHT = 3750.0,						-- Maximum camera height - AMYZ EDITED was 3000
	...
	FRONTEND_LOOK_Y = 0.0,
	FRONTEND_LOOK_Z = 2215.0, -- AMYZ was 1519
...
NReligion = {
	COUNCIL_BASE_COST = 100000,			-- Anbennar - changes for ravelian
	...
	CONSECRATE_PATRIARCH_THRESHOLD = 10, --in development | Anbennar - changes for gnolls
